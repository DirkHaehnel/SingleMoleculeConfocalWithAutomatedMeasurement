...
#define PI_CNTR_DIFFERENT_ARRAY_LENGTH  70  /**< \ingroup err
		GCS-Array doesn't support different lengths; request arrays with different lengths separately */
...
#define PI_CNTR_ANALOG_TARGET_ACTIVE  72  /**< \ingroup err
		MOV, MVR, SVA, SVR, STE, IMP and WGO not allowed when analog target is active */
#define PI_CNTR_WAVE_GENERATOR_ACTIVE  73  /**< \ingroup err
		MOV, MVR, SVA, SVR, STE and IMP not allowed when wave generator is active */
